...
export const challengeSummaryRows = [
  ["1", "Requirements Capture", "30 min", "20", "<code>requirements</code>"],
  ["2", "Architecture Design", "30 min", "25", "<code>architect</code>"],
  [
    "3",
    "IaC Implementation &amp; Deploy",
    "45 min",
    "25",
    "<code>bicep-plan</code>/<code>terraform-plan</code>, <code>bicep-code</code>/<code>terraform-code</code>, <code>deploy</code>",
  ],
  [
    "4",
    "DR Curveball &amp; Deploy",
    "45 min",
    "10",
    "<code>bicep-plan</code>, <code>bicep-code</code>, <code>deploy</code>",
  ],
  ["5", "Load Testing", "30 min", "5", "(k6 scripts)"],
  ["6", "Documentation", "15 min", "5", "<code>design</code>"],
  ["7", "Diagnostics", "5 min", "5", "<code>diagnose</code>"],
